...
<body>
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark justify-content-center">
		<ul class="nav nav-tabs">
			...
			<li class="nav-item">
				<a class="nav-link active" href="login.php">Bejelentkezés</a>
			</li>
		</ul>
	</nav>
	<div class="loginPage">
		<div class="loginDiv">
			<form action="szkriptek/loginDatas.php" method="post">
				...
				<button class="gomb" type="submit" name="submit">Bejelentkezés</button><br>
				<p id="registerlink">Nincs még fiókja? Regisztráljon <a href="register.html">itt</a></p>
			</form>

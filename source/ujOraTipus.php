...
<body>
	...
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark justify-content-center">
	 ...
	 <li class="nav-item">
		...
		<div class="oldal">
			<div class="adatlap">
				<p class="cim">Új óratípus felvétele</p>

				<form class="adatok" method="POST" action="szkriptek/ujOraTipusDatas.php">
					<table class="urlap_tabla">
						<tr>
						  <td class="urlap_cella"><label for="nev" class="adat1">Típus neve:</label></td>
						  <td class="urlap_cella"><input type="text" id="nev" name="nev"></td>
						</tr>
						<tr>
